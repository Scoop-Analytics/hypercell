 ...
 * @author bradpeters
 */
public class MemSheet implements com.scoopanalytics.hypercell.api.EvaluationContext
{
    ...
    public Map<MemCell, com.scoopanalytics.hypercell.core.expression.SpillArea> getSpillAreaCache()
    {
    ...
    @Override
    public java.util.List<com.scoopanalytics.hypercell.api.DataSource> getDataSources() {
        return java.util.Collections.emptyList(); // Not used in standalone version
    }

    @Override
    public void refreshDataSource(com.scoopanalytics.hypercell.api.DataSource dataSource) {
