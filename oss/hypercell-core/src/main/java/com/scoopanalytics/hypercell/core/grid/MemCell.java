...
import com.scoopanalytics.hypercell.api.CellAddress;
import com.scoopanalytics.hypercell.core.expression.Compile;
import com.scoopanalytics.hypercell.core.expression.Identifier;
import com.scoopanalytics.hypercell.core.expression.Range;
import com.scoopanalytics.hypercell.core.expression.SpillArea;
import com.scoopanalytics.hypercell.core.expression.ThrowingErrorListener;
import com.scoopanalytics.hypercell.formula.HyperCellExpressionParser.ExpressionContext;
import com.scoopanalytics.hypercell.core.util.DateFormatUtils;
 ...
 * @author bradpeters
 */
public class MemCell implements com.scoopanalytics.hypercell.api.CellValue { 
    ...
    @Override public com.scoopanalytics.hypercell.api.CellValue[][] getArrayValue() { return array; }
    ...
    public void compileFormula(MemSheet memSheet)
    {
        ...
        com.scoopanalytics.hypercell.formula.HyperCellExpressionLexer lex = new com.scoopanalytics.hypercell.formula.HyperCellExpressionLexer(input);
        lex.removeErrorListeners();
        lex.addErrorListener(com.scoopanalytics.hypercell.core.expression.ThrowingErrorListener.INSTANCE);
        CommonTokenStream tokens = new CommonTokenStream(lex);
        com.scoopanalytics.hypercell.formula.HyperCellExpressionParser parser = new com.scoopanalytics.hypercell.formula.HyperCellExpressionParser(tokens);
        parser.removeErrorListeners();
        parser.addErrorListener(com.scoopanalytics.hypercell.core.expression.ThrowingErrorListener.INSTANCE);
        ...
        compile = new Compile(expressionContext, new com.scoopanalytics.hypercell.core.expression.CompileContext(memSheet));
        if (!compile.isInformationalOnly())
        {
            ...
            com.scoopanalytics.hypercell.core.expression.HyperCellExpression expr = compile.getExpression();
            if (expr != null)
            {
