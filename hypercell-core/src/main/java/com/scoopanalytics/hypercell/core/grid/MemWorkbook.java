...
import com.scoopanalytics.hypercell.api.RangeAddress;
 ...
 * @author bradpeters
 */
public class MemWorkbook implements com.scoopanalytics.hypercell.api.WorkbookDimensions
{
    ...
    public MemWorkbook(com.scoopanalytics.hypercell.api.EvaluationContext context, String name, org.apache.poi.ss.usermodel.Workbook wb, boolean b) {
        this.name = name;
        this.registry = new com.scoopanalytics.hypercell.api.FunctionRegistry() {
            public void register(String name, com.scoopanalytics.hypercell.api.Function function) {}
            public com.scoopanalytics.hypercell.api.Function getFunction(String name) { return null; }
        };
    }
    ...
    public void calculate(com.scoopanalytics.hypercell.api.EvaluationContext context) {
        calculate();
    }
    ...
    public static Kryo getKryo()
    {
        ...
        kryo.register(com.scoopanalytics.hypercell.api.CellAddress.class);
        kryo.register(com.scoopanalytics.hypercell.api.RangeAddress.class);
